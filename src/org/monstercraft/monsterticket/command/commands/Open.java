...
public class Open extends GameCommand {
	...
	public boolean canExecute(CommandSender sender, String[] split) {
		return split[0].equalsIgnoreCase("modreq");
	}
	...
	public boolean execute(CommandSender sender, String[] split) {
		if (sender instanceof Player) {
			...
			sender.sendMessage("You must be a player to open a support ticket!");
			return true;
		}
		...
		if (split.length < 2) {
			sender.sendMessage(ChatColor.RED + "Invalid description of problem");
			return true;
		}
